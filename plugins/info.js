...
if (Config.WORKTYPE == 'private') {
   Asena.addCommand({ pattern: 'info', fromMe: true,  deleteCommand: false,  desc: 'GROUP INFO'}, async (message, match) => { 
    ...
    Asena.addCommand({ pattern: 'info', fromMe: false, desc: 'GROUP INFO'}, async (message, match) => { 
